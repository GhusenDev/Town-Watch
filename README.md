...
1. Open Age of Empires II: Definitive Edition and enter a match lobby.
2. Click on player profile icons in the lobby.
3. This will open the official AoE stats page in your browser.
4. Copy the Profile ID from the URL (example below):
https://www.ageofempires.com/stats/?game=age2&profileId=4107783  
→ The number at the end is the Profile ID.
5. Enter the Profile ID into TownWatch.

F8 → Toggle HUD on/off  
